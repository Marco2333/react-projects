webpackJsonp([3],Array(388).concat([
/* 388 */
...
exports.initialState = exports.stateKey = exports.reducer = exports.Category = undefined;

var _category = __webpack_require__(876);
...
var reducer = _defineProperty({}, _category.stateKey, _category.reducer);

var initialState = _defineProperty({}, _category.stateKey, _category.initialState);

exports.Category = _category2.default;
exports.reducer = reducer;
exports.stateKey = _category.stateKey;
...
exports.getCategory = exports.categoryFailure = exports.categorySuccess = exports.categoryStarted = undefined;

var _actionTypes = __webpack_require__(845);

var _config = __webpack_require__(169);

var categoryStarted = exports.categoryStarted = function categoryStarted() {
    return {
        type: _actionTypes.FETCH_STARTED
    };
};

var categorySuccess = exports.categorySuccess = function categorySuccess(infos) {
    return {
...
var categoryFailure = exports.categoryFailure = function categoryFailure(message) {
    return {
...
var getCategory = exports.getCategory = function getCategory(current, count, category) {
    return function (dispatch) {
        var apiUrl = _config.SERVERADDRESS + '/get-category?category=' + category + '&count=' + count + '&current=' + current;
...
var FETCH_STARTED = exports.FETCH_STARTED = 'CATEGORY/STARTED';
var FETCH_SUCCESS = exports.FETCH_SUCCESS = 'CATEGORY/SUCCESS';
var FETCH_FAILURE = exports.FETCH_FAILURE = 'CATEGORY/FAILURE';
...
var _view = __webpack_require__(877);

var _view2 = _interopRequireDefault(_view);

var _actions = __webpack_require__(844);
...
var stateKey = exports.stateKey = "category";
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        getCategory: function getCategory(current, count, category) {
            dispatch((0, _actions.getCategory)(current, count, category));
        }
    };
};
